...
{
    public class JumpWithEnergyTutorialMessage : TutorialMessage
    {
        ...
        {
            _slowMotionService.StopAllSlowMo();
        ...
        private void Update()
        {
            ...
            if (Input.GetMouseButtonUp(0))
            {
                ...
                {
                    _messageBoxService.CloseScreen<JumpWithEnergyTutorialMessage>();
                }
            }
        }
